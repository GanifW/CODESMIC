...
const learningFeatures = [
  {
    ...
    glow: "pink",
    route: "/fix-run-lab",
    features: ["Live Preview", "Visual Diff", "Smart Hint Available"],
  },
  {
    icon: Code2,
    ...
    features: ["Multi-level Challenges", "Smart Hint Available", "XP Rewards"],
  },
  {
    icon: Bug,
    ...
    features: ["Error Pattern Analysis", "Smart Hint Available", "Debugging Tools"],
  },
];
          ...
          <div className="container mx-auto relative z-10 text-center">
            ...
            >
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto mb-8">
                Jelajahi 3 fitur utama yang dirancang secara berurutan untuk mengasah skill coding dan problem solving-mu.
                Mulai dari basic fix sampai mengasah kemampuan debugging dan challenge solving.
              </p>
                          ...
                          <div className="relative z-10 flex flex-col md:flex-row gap-6">
                            ...
                            <div className="flex md:flex-col items-center md:items-start gap-4 md:gap-3">
                              <div className="relative flex-shrink-0">
                                <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${feature.color} flex items-center justify-center shadow-lg ${getGlowClasses(feature.glow)}`}>
